...
pub enum TextKey {
    ...
    L1VramCache,
    L2RamCache,
    L2RamCacheDescription,
    AdjacentBookPreloadRam,
    AdjacentBookPreloadRamDescription,
    GPUKeepNote,
    CacheResetDefault,
    CacheUpperLimit,
    CacheUsage,
    ...
    Open,
    OpenInExplorer,
    AddTreeFolderToLibrary,
    RemoveTreeFolderFromLibrary,
    TreeFolderRegistered,
    MoveToFolder,
    AddToFavorites,
    RemoveFromFavorites,
    Properties,
...
fn english_text(key: TextKey) -> &'static str {
    let text = match key {
        ...
        TextKey::AddTreeFolderToLibrary => "Add to Library",
        TextKey::RemoveTreeFolderFromLibrary => "Remove from Library",
        TextKey::TreeFolderRegistered => "Registered in Library",
        ...
        TextKey::FilterTokenCompact => "Filter: \"{}\"",
        TextKey::ClearFilter => "Clear Filter",
        TextKey::CopyToken => "Copy \"{}\"",
        TextKey::CopyTokenCompact => "Copy: \"{}\"",
        TextKey::WebSearchToken => "Search \"{}\" on the Web",
        TextKey::WebSearchTokenCompact => "Web Search: \"{}\"",
        ...
        TextKey::PropertiesTitle => "Properties",
        ...
        TextKey::SizeLabel => "Size",
        TextKey::PageCountLabel => "Pages",
        TextKey::PageMapUnavailableHud => "Some pages may be unavailable",
        TextKey::PathLabel => "Path",
        TextKey::TypeLabel => "Type",
        TextKey::ModifiedAt => "Modified",
        TextKey::Close => "Close",
        ...
        TextKey::WebSearch => "Web Search",
        TextKey::Browser => "Browser",
        TextKey::OpenMode => "Open Mode",
        TextKey::DisplayLabel => "Display",
        TextKey::LinkLabel => "Link",
        TextKey::WebSearchEntryLabel => "Search",
        TextKey::WebSearchLinkPlaceholder => "https://example.com/search?q=%s",
        TextKey::WebSearchLinkNote => {
...
fn japanese_text(key: TextKey) -> Option<&'static str> {
    match key {
        ...
        TextKey::AddTreeFolderToLibrary => Some("ライブラリに追加"),
        TextKey::RemoveTreeFolderFromLibrary => Some("ライブラリから解除"),
        TextKey::TreeFolderRegistered => Some("ライブラリに登録済み"),
        TextKey::MoveToFolder => Some("フォルダへ移動"),
        TextKey::AddToFavorites => Some("お気に入りに追加"),
        TextKey::RemoveFromFavorites => Some("お気に入りから解除"),
        TextKey::Properties => Some("プロパティ"),
        ...
        TextKey::FilterTokenCompact => Some("\"{}\" でフィルタリング"),
        TextKey::ClearFilter => Some("フィルタリングをクリア"),
        TextKey::CopyToken => Some("\"{}\" をコピー"),
        TextKey::CopyTokenCompact => Some("\"{}\" をコピー"),
        TextKey::WebSearchToken => Some("\"{}\"をWEB検索"),
        TextKey::WebSearchTokenCompact => Some("\"{}\"をWEB検索"),
        ...
        TextKey::PropertiesTitle => Some("プロパティ"),
        ...
        TextKey::SizeLabel => Some("サイズ"),
        TextKey::PageCountLabel => Some("ページ数"),
        TextKey::PageMapUnavailableHud => Some("一部のページを確認できません"),
        TextKey::PathLabel => Some("パス"),
        TextKey::TypeLabel => Some("種類"),
        TextKey::ModifiedAt => Some("更新日時"),
        TextKey::Close => Some("閉じる"),
        ...
        TextKey::WebSearch => Some("WEB検索"),
        TextKey::Browser => Some("ブラウザ"),
        TextKey::OpenMode => Some("開き方"),
        TextKey::DisplayLabel => Some("表示"),
        TextKey::LinkLabel => Some("Link"),
        TextKey::WebSearchEntryLabel => Some("検索先"),
        TextKey::WebSearchLinkPlaceholder => Some("https://example.com/search?q=%s"),
        TextKey::WebSearchLinkNote => Some(
