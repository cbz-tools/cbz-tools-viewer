...
mod tests {
    ...
    #[test]
    fn parse_full_pattern_with_suffix() {
        let p = parse_filename("(C100) [CreatorA (AliasA)] SampleName (WorkA) [EditionA].zip");
        assert_eq!(
            p.parts,
            vec![
                FilenamePart {
                    role: FilenamePartRole::Kind,
                    text: "C100".to_string()
                },
                FilenamePart {
                    role: FilenamePartRole::Author,
                    text: "CreatorA".to_string()
                },
                FilenamePart {
                    role: FilenamePartRole::AuthorAlias,
                    text: "AliasA".to_string()
                },
                FilenamePart {
                    role: FilenamePartRole::Title,
                    text: "SampleName".to_string()
                },
                FilenamePart {
                    role: FilenamePartRole::Work,
                    text: "WorkA".to_string()
                },
                FilenamePart {
                    role: FilenamePartRole::Edition,
                    text: "EditionA".to_string()
                },
            ]
        );
    }
    ...
    #[test]
    fn parse_author_and_title() {
        let p = parse_filename("[Creator] SampleName.zip");
        assert_eq!(
            p.parts,
            vec![
                FilenamePart {
    ...
    #[test]
    fn parse_kind_and_title() {
        let p = parse_filename("(種類) SampleName.zip");
        assert_eq!(
            p.parts,
            vec![
                FilenamePart {
    ...
    #[test]
    fn parse_title_only() {
        let p = parse_filename("SampleName.zip");
        assert_eq!(
            p.parts,
            vec![FilenamePart {
                role: FilenamePartRole::Title,
    ...
    #[test]
    fn parse_invalid_unclosed_bracket_as_title() {
        let p = parse_filename("[Creator");
        assert_eq!(
            p.parts,
            vec![FilenamePart {
                role: FilenamePartRole::Title,
        ...
        assert!(p.warnings.contains(&ParseWarning::UnmatchedBracket));
    }
    ...
    fn parse_empty_string() {
        ...
        assert!(p.warnings.contains(&ParseWarning::EmptyInput));
    }

    #[test]
    fn keep_middle_parentheses_in_title() {
        let p = parse_filename("SampleName(完全版).zip");
        assert_eq!(
            p.parts,
            vec![FilenamePart {
                role: FilenamePartRole::Title,
                text: "SampleName(完全版)".to_string()
            },]
        );
    }
}
